...
if(isset($_POST['submit']))
{
    ...
    try {
        $sql = $DB_con->prepare("INSERT INTO doctors (specilization, doctorName, address, docFees, contactno, docEmail, password) VALUES (:docspecialization, :docname, :docaddress, :docfees, :doccontactno, :docemail, :password)");
        $sql->bindParam(':docspecialization', $docspecialization);
        $sql->bindParam(':docname', $docname);
        $sql->bindParam(':docaddress', $docaddress);
        $sql->bindParam(':docfees', $docfees);
        $sql->bindParam(':doccontactno', $doccontactno);
        $sql->bindParam(':docemail', $docemail);
                                                ...
                                                <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="Doctorspecialization" class="form-control" required="required">
                                                            ...
                                                            <?php
                                                            try {
                                                                $ret = $DB_con->query("SELECT * FROM doctorspecilization");
