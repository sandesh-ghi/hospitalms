...
if (isset($_POST['submit'])) {
    ...
    // Prepare and bind
    $stmt = $bd->prepare("UPDATE doctors SET specilization = ?, doctorName = ?, address = ?, docFees = ?, contactno = ? WHERE docEmail = ?");
    $stmt->bind_param('ssssss', $docspecialization, $docname, $docaddress, $docfees, $doccontactno, $_SESSION['dlogin']);
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                <?php
                                                // Prepare and execute the query to fetch the doctor details
                                                $stmt = $bd->prepare("SELECT * FROM doctors WHERE docEmail = ?");
                                                $stmt->bind_param('s', $_SESSION['dlogin']);
                                                $stmt->execute();
